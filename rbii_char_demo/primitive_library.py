...
def create_default_primitive_library() -> PrimitiveLibrary:
    ...
    library.register_primitive("if_then_else", if_then_else, description_length_bits=1)
    library.register_primitive("equals", equals, description_length_bits=1)
    library.register_primitive("add_real_numbers", add_real_numbers, description_length_bits=1)
    library.register_primitive("subtract_real_numbers", subtract_real_numbers, description_length_bits=1)
    library.register_primitive("multiply_real_numbers", multiply_real_numbers, description_length_bits=1)
    ...
    def uniform_character_distribution(evaluation_context: Any) -> numpy.ndarray:
        ...
        return numpy.ones(vocabulary_size, dtype=numpy.float64) / float(vocabulary_size)
    ...
    def digit_cycle_character_distribution(evaluation_context: Any, step_size: int) -> numpy.ndarray:
        ...
        last_character_index = evaluation_context.prediction_features.recent_character_indices[-1]
    ...
    library.register_primitive("uniform_character_distribution", uniform_character_distribution, description_length_bits=2)
    library.register_primitive("bigram_character_distribution", bigram_character_distribution, description_length_bits=3)
    library.register_primitive("trigram_character_distribution", trigram_character_distribution, description_length_bits=4)
    library.register_primitive("mixture_of_two_character_distributions", mixture_of_two_character_distributions, description_length_bits=3)
    library.register_primitive("digit_cycle_character_distribution", digit_cycle_character_distribution, description_length_bits=5)
