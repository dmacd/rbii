...
class PriorConsistentNewbornWeightAssignmentPolicy:
    def compute_initial_log_weight_base_two(
        ...
        return float(log_total_weight_base_two) - float(transformer_description_length_bits)
...
class FixedFractionNewbornWeightAssignmentPolicy:
    ...
    def compute_initial_log_weight_base_two(
        ...
        return float(log_total_weight_base_two) + math.log2(self.fraction_of_total_weight)
